  ...
  return (
    <>
      ...
      <div style={{ background: '#fff', borderTop: '1px solid #000', borderBottom: '1px solid #000' }} id="order">
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '7rem 3rem', display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: '6rem', alignItems: 'start' }}>
          ...
          <div style={{ background: '#fff', border: '1px solid #000', padding: '2.5rem' }}>
            {submitted ? (
              ...
              <form action="https://formspree.io/f/YOUR_FORM_ID" method="POST" encType="multipart/form-data" onSubmit={handleSubmit}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '2rem', paddingTop: '1.75rem', borderTop: '1px solid #000', gap: '1rem', flexWrap: 'wrap' }}>
